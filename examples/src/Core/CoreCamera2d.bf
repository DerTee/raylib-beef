...
namespace raylib_beef.examples.Core
{
	class Camera2d : Raylib
	{
		public static void Main()
		{
			...
			Rectangle[maxBuildings] buildings;
			Color[maxBuildings] buildColors;
			int spacing = 0;

			for (int i < maxBuildings)
			{
				...
				buildColors[i] = Color((uint8)GetRandomValue(200, 240), (uint8)GetRandomValue(200, 240), (uint8)GetRandomValue(200, 240), 255);
			}
